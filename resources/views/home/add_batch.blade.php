            ...
            <form id="add-batch-form" class="mt-6 space-y-5">
                <section class="rounded-2xl border border-slate-200 bg-slate-50/60 p-3">
                    ...
                    <div class="mt-2 flex flex-wrap gap-2">
                        <button type="button" data-fill-batch-stage="weaner" class="rounded-full border border-emerald-200 bg-white px-3 py-1.5 text-xs font-semibold text-emerald-700 transition hover:bg-emerald-50">Weaner</button>
                        <button type="button" data-fill-batch-stage="grower" class="rounded-full border border-emerald-200 bg-white px-3 py-1.5 text-xs font-semibold text-emerald-700 transition hover:bg-emerald-50">Grower</button>
                        <button type="button" data-fill-batch-stage="finisher" class="rounded-full border border-emerald-200 bg-white px-3 py-1.5 text-xs font-semibold text-emerald-700 transition hover:bg-emerald-50">Finisher</button>
                    </div>
                </section>
